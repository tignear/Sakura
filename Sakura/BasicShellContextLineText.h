...
namespace tignear::sakura {
	...
	public:
		attrtext_iterator_impl(std::list<AttributeTextImpl>::const_iterator elem) :
			m_elem(elem) {
		}
	...
	private:
		...
		std::list<AttributeTextImpl>::const_iterator m_elem;
	};
	...
	public:
		...
		ShellContext::attrtext_iterator begin()const override;
		ShellContext::attrtext_iterator end()const override;
